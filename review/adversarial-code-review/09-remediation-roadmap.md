...
| WP5-03 2.2.1 candidate and signed smoke | `24d7416`, `50e82f7`, `4414dfc`, `71ba271`, `a43745a`, `feb2529`, `629e72d`, `24d8538`, `183162b`, `22d9c1d`, `0e34bde`, `090b04b`, `f45b5dc`, `bb17895`, `51fb861`, `d795f57` | `e8e8be2`, `7983602`, `e051c78`, `4cdd40c`, `89473ef`, `66d6c6e`, `6929764`, `f7feae6`, `c54acf9`, `f009d9d` | Candidate 2.2.1 build 387, repository-owned signed-app/XPC smoke, recursively strict reproducible evidence, post-smoke app revalidation, and exact isolated-runner policy are encoded. No live release or appcast was published. |
| WP6-01/02 claims and accessibility | `aadd058`, `d7def2e`, `d05062f`, `e3a28c5` | `05c488e`, `4e08203`, `815180c`, `073fe65`, `19e06b4`, `e8ac6cd`, `fce83eb` | Twenty-one versioned claims are bound to executable evidence; remediation warnings and smoke hooks are accessible and fail closed; the final window-stability selectors passed. |
| WP6-03 window and CI portability | `0a452dd`, `ddda8b6` | `3a55987`, `f24c792` | Live-resize observers synchronously re-enter the main actor without changing event ordering; the output warning smoke verifies row existence/hittability and deterministically enters the production navigation destination under local Xcode 27 and GitHub Xcode 16.4. |
...
| WP4-04 content-bound XPC snapshots | `417511c`, `2b45a14`, `f9ffea3`, `a387a19` | `1c4e5fa`, `67749f4`, `e1d60b5`, `fce83eb` | Release model load copies the verified revision-bound tree into a private XPC snapshot, rehashes and attests the exact fingerprint, retains directory descriptors through load/generation/unload, and retries bounded descriptor-anchored cleanup. MLX pathname loading leaves same-UID mutate/restore and unlink races as an isolated-runner boundary, not a claimed hash-only closure. |
...
- SA-ACR-004 is remediated at `f24c792179137557ae61f259f18a209c9790b345`: the final app/UI/XPC smoke passed 5/5, including the 2/2 drafting/output vertical-window subset; the earlier granular evidence remains recorded separately. Exact evidence is in `11-command-and-evidence-log.md`.
- SA-ACR-012 is mitigated because source controls, repository-owned smoke code, and isolated-runner policy exist, while live protected rulesets/environments, the required runner/resources, and a signed/notarized rehearsal remain external.
- SA-ACR-010 is remediated at the deterministic manifest/content-binding/private-snapshot boundary; real-weight load/resource qualification and the isolated same-UID pathname threat remain stated limitations.
...
The historical WP4-02 contract above called for a real signed XPC boundary. Execution exercised the actual embedded service through a locally ad-hoc-signed host, not a Developer ID signed release candidate. It did not run a hostile Developer ID peer negative case or a forced service kill/relaunch case. The deterministic hosted test did cover connection-bound ownership, cancellation, exactly-once terminal delivery, reconnect, load/unload races, and 20/20 lifecycle iterations; the final app/UI/XPC smoke re-exercised the hosted selectors at the final source SHA. Sanitizer results belong to the earlier integrated snapshot on which they ran and were not relabeled as a rerun at `f24c792`. WP4-03 remains incomplete for protected real weights, long generation, peak RSS, production memory pressure, and Instruments.

Implementation completion is not authorization to publish. Existing public refs/caches remain assigned to GitHub Support. Before a production release, the release owner must still obtain attorney approval for the support corpus and user-facing legal semantics; enable and verify the protected macOS rulesets/environment and isolated Apple Silicon release runner; and produce a Developer ID signed, notarized, stapled release candidate whose manifest and artifacts bind to `f24c792179137557ae61f259f18a209c9790b345`. That candidate must complete the protected real-weight/content-bound XPC smoke and publication/appcast/rollback rehearsal. The release transaction must remain a dry run until those conditions are satisfied.
