...
- SA-ACR-004 is remediated at `fce83ebf462c76b60203eb9ccb5db4ed00c7a0de`: the final drafting/output vertical-window regression selectors passed 2/2; the earlier billing warning selector remains recorded separately. Exact evidence is in `11-command-and-evidence-log.md`.
