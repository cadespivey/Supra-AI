...
even when marker removal became visible before its directory sync completed. Supra AI removes only
that authenticated operation's private staging tree after marker consumption. Cleanup is retried
