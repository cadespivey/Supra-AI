...
The metadata audit runs on a schedule or manual dispatch through
`.github/workflows/security-scheduled.yml`. Website deployments run its synthetic regression suite plus the existing
