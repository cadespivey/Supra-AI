...
final class LetterheadRendererTests: XCTestCase {
    ...
    private var letterModel: LetterModel {
        LetterModel(
            letterhead: LetterheadFill(firmName: "Pearson Specter Litt", office: profileOffice),
    ...
    func testLetterheadIsCenteredFirmName16ptTaglineItalic10pt() {
        ...
        XCTAssertTrue(xml.contains(#"<w:pPr><w:jc w:val="center"/></w:pPr><w:r><w:rPr><w:b/><w:sz w:val="32"/><w:szCs w:val="32"/></w:rPr><w:t xml:space="preserve">Pearson Specter Litt</w:t></w:r>"#))
    ...
    func testRELineBoldHangingIndent() {
        let xml = LetterheadRenderer().documentXML(letterModel, style: .defaultFL)
        XCTAssertTrue(xml.contains(#"<w:ind w:left="1440" w:hanging="720"/></w:pPr><w:r><w:rPr><w:b/></w:rPr><w:t xml:space="preserve">RE:</w:t></w:r><w:r><w:rPr><w:b/></w:rPr><w:tab/></w:r><w:r><w:rPr><w:b/></w:rPr><w:t xml:space="preserve">Outstanding Balance Owed to McKernon Motors — Demand for Payment</w:t></w:r>"#))
    }

    func testBodyIsJustifiedBlockNoFirstLineIndent() {
        let xml = LetterheadRenderer().documentXML(letterModel, style: .defaultFL)
        // body paragraph: jc both, no firstLine indent
        XCTAssertTrue(xml.contains(#"<w:p><w:pPr><w:jc w:val="both"/></w:pPr><w:r><w:t xml:space="preserve">This firm represents McKernon Motors.</w:t></w:r></w:p>"#))
    ...
    func testClosingAndSignatureInRightHalfNoSlash() {
        ...
        XCTAssertTrue(xml.contains(#"<w:p><w:pPr><w:ind w:left="4680"/></w:pPr><w:r><w:t xml:space="preserve">Harvey Specter</w:t></w:r></w:p>"#))
    ...
    func testEnclosureAndCcAtLeftMargin() {
        ...
        XCTAssertTrue(xml.contains(#"<w:p><w:r><w:t xml:space="preserve">cc:  McKernon Motors</w:t></w:r></w:p>"#))
    }
    ...
    func testNoBakedIdentityFirmAVsFirmB() {
        let firmB = LetterModel(
            letterhead: LetterheadFill(firmName: "Rand Kaldor Zane",
            ...
            signerName: "Harvey Specter", signerTitle: nil, enclosures: [], cc: []
        )
        ...
        XCTAssertTrue(xmlA.contains("Pearson Specter Litt"))
        XCTAssertFalse(xmlA.contains("Rand Kaldor Zane"))
        XCTAssertTrue(xmlB.contains("Rand Kaldor Zane"))
        XCTAssertFalse(xmlB.contains("Pearson Specter Litt"))
    }
}
