...
/// approximate on-disk footprints; most are `mlx-community` builds (the Qwen3 Thinking
/// 6/8-bit higher-precision options come from `lmstudio-community`, which is where
/// those MLX quants are published). The first three
