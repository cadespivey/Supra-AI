...
public enum BenchmarkMetricCatalog {
    public static let all: [BenchmarkMetricDefinition] = [
        ...
        .init(id: "B-PERF-01", title: "Latency", unavailableReason: "emitted by the separate fixed-hardware performance report"),
        .init(id: "B-PERF-02", title: "Throughput and memory", unavailableReason: "emitted by the separate fixed-hardware performance report"),
        .init(id: "B-PERF-03", title: "Incremental work", unavailableReason: "emitted by the separate fixed-hardware performance report"),
