    ...
    func testACRFILE024ValidatorMutationClassifiesPublicOnlyExactSurvivor() throws {
        for throwsAfterMutation in [false, true] {
            let root = FileManager.default.temporaryDirectory
                .appendingPathComponent("Supra-Validator-Mutation-\(UUID().uuidString)", isDirectory: true)
            ...
            XCTAssertThrowsError(
                try writer.removeInstalledFile(
                    ...
                    contentValidator: { _ in
                        ...
                        guard validationCallCount == 1 else { return }
                ...
                XCTAssertTrue(
                    ...
                    "throws=\(throwsAfterMutation), error=\(error)"
                )
            }
